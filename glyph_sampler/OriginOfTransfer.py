...
part_list.append(['OriginOfTransfer', None, None])
part_list.append(['OriginOfTransfer', {'rotation':3.14}, None])
...
fig.savefig('OriginOfTransfer.pdf', transparent=True, dpi=300)
