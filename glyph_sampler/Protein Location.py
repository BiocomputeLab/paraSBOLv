...
part_list.append(['Protein Location', None, None])
part_list.append(['Protein Location', {'rotation':3.14}, None])
...
fig.savefig('Protein Location.pdf', transparent=True, dpi=300)
